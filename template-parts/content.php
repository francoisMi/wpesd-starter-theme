		...
		<div class="entry-content" itemprop="articleBody">
			...
			the_content( sprintf(
				wp_kses(
					...
					__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'wpesd' ),
					array(
						'span' => array(
							'class' => array(),
						),
			...
			wp_link_pages( array(
				'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'wpesd' ),
				'after'  => '</div>',
			) );
			?>
		</div><!-- .entry-content -->
